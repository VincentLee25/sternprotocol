...
const { installStubIdentityRoutes } = require("./identity-gateway-stub");
...
installStubIdentityRoutes(app)
  .then(() => app.listen(PORT, () => console.log(`documents stub on :${PORT} (ipfs stub on :${IPFS_PORT}, store ${tmp})`)))
