...
const TERMS = [
  { k: "T+0", v: "Settlement on attestation, not on document courier" },
  { k: "5", v: "Independent trade checks required before release" },
  { k: "2/3", v: "Oracle consensus, deviating signers slashed 50%" },
...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "Attest",
    d: "Oracles independently report weight, departure, customs, hash and inspection. Majority wins."
  },
  {
    n: "03",
    t: "Release",
