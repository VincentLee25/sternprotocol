        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {VERIFIERS.map((v) => (
            <div key={v.role} className="flex flex-col rounded-doc border border-alabaster/10 p-6">
              <p className="font-mono text-2xs text-teal">{v.role}</p>
        ...
        <div className="grid gap-px overflow-hidden rounded-doc bg-alabaster/10 sm:grid-cols-2 lg:grid-cols-5">
          {LIFECYCLE.map((step) => (
            <div key={step.n} className="bg-onyx p-5">
              <p className="font-mono text-2xs text-teal">{step.n}</p>
              <h3 className="mt-2.5 text-[16px] font-medium">{step.t}</h3>
              <p className="mt-2 font-serif text-[14px] leading-relaxed text-alabaster/[0.55]">
                {step.d}
              </p>
            </div>
          ))}
      ...
      >
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)]">
          <div className="rounded-doc border border-alabaster/10 p-6">
            <p className="font-mono text-2xs uppercase text-alabaster/40">Posted verifier bond</p>

            <div className="mt-4 flex h-12 overflow-hidden rounded-panel">
              <div className="flex w-1/2 items-center justify-center bg-state-disputed/25 font-mono text-2xs uppercase text-state-disputed">
                slashed 50%
              </div>
              <div className="flex w-1/2 items-center justify-center bg-alabaster/[0.07] font-mono text-2xs uppercase text-alabaster/45">
                stays staked
              </div>
            </div>
            ...
            <p className="mt-3 font-mono text-2xs uppercase text-alabaster/35">
              Split of the slashed half only
            </p>

            <p className="mt-5 font-serif text-[15px] leading-relaxed text-alabaster/[0.58]">
            ...
            <p className="mt-4 font-serif text-[15px] leading-relaxed text-alabaster/[0.58]">
          ...
          <div className="rounded-doc border border-alabaster/10 p-6">
            <p className="font-mono text-2xs uppercase text-alabaster/40">Parameters</p>
        ...
        <div className="grid gap-px overflow-hidden rounded-doc bg-alabaster/10 sm:grid-cols-2">
          {ASSUMPTIONS.map((a) => (
            <div key={a.t} className="bg-onyx p-6">
              ...
              <p className="mt-2.5 font-serif text-[15px] leading-relaxed text-alabaster/[0.55]">
                {a.d}
              </p>
            </div>
          ))}
