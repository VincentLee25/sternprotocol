      ...
      >
        <div className="overflow-hidden rounded-doc border border-alabaster/10">
          <div className="hidden grid-cols-[minmax(0,1fr)_minmax(0,1.25fr)_minmax(0,1.25fr)] gap-px bg-alabaster/10 lg:grid">
            <div className="bg-onyx px-5 py-3 font-mono text-2xs uppercase text-alabaster/40">
              Dimension
            </div>
            <div className="bg-onyx px-5 py-3 font-mono text-2xs uppercase text-alabaster/40">
              Letter of credit
            </div>
            <div className="bg-onyx px-5 py-3 font-mono text-2xs uppercase text-teal">STERN</div>
          </div>
          <div className="grid gap-px bg-alabaster/10">
            {COMPARISON.map((row) => (
              ...
              >
                ...
                <div className="bg-onyx px-5 py-4 font-serif text-[15px] leading-relaxed text-alabaster/[0.55]">
                  {row.lc}
                </div>
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {ARTICLES.map((article) => (
            <div key={article.n} className="rounded-doc border border-alabaster/10 p-6">
              <p className="font-mono text-2xs uppercase text-teal">{article.n}</p>
              <h3 className="mt-3 text-[20px] font-medium tracking-[-0.02em]">{article.t}</h3>
              <p className="mt-2 font-serif text-[15px] leading-relaxed text-alabaster/[0.55]">
                {article.d}
              </p>
