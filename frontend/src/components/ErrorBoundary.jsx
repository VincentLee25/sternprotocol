  ...
  render() {
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center bg-beige p-8">
        <div className="w-full max-w-lg rounded-doc border border-state-disputed/40 bg-surface p-6 shadow-card">
          <p className="text-2xs font-semibold uppercase tracking-micro text-state-disputed">Application error</p>
          ...
          <pre className="mt-4 max-h-64 overflow-auto rounded-panel bg-surface-soft px-3.5 py-3 font-mono text-2xs leading-relaxed text-ink-dim">
